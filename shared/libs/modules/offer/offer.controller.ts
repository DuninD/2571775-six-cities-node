...
import { BaseController, DocumentExistsMiddleware, HttpError, PrivateRouteMiddleware, ValidateDtoMiddleware, ValidateObjectIdMiddleware } from '../../rest/index.js';
...
export class OfferController extends BaseController {
  ...
  public async getAll(
    { body, tokenPayload } : GetAllOfferRequest,
    res: Response
  ): Promise<void> {
